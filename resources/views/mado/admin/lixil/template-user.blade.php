...
<header>
    <div class="headerInr">
        <p class="logo">
            ...
            <a href="{{ route('admin.lixil') }}"><img src="{{ asset('img/header_logo.png') }}" alt="simple estimation system" width="183" height="31"></a>
            @else {{--general--}}
            <a href="{{ route('admin.lixil') }}"><img src="{{ asset('estimate/img/icon/h_logo.png') }}" alt="simple estimation system" width="124" height="67"></a>
            @endif
        </p>
...
<header>
    <div class="headerInr">
        <p class="logo">
            @if ( \Schema::hasColumn('shops', 'shop_type') === false ) {{--portal--}}
            <a href="{{ route('admin.shop', ['shop_id' => Auth::user()->shop->id]) }}"><img src="{{ asset('img/header_logo.png') }}" alt="simple estimation system" width="183" height="31"></a>
            @else {{--general--}}
            <a href="{{ route('admin.shop', ['shop_id' => Auth::user()->shop->id]) }}"><img src="{{ asset('estimate/img/icon/h_logo.png') }}" alt="LIXIL administrator" width="124" height="67"></a>
            @endif
        </p>
