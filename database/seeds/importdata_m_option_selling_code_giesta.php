...
class importdata_m_option_selling_code_giesta extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $txt_file = storage_path() . '/import_data/m_option_selling_code_giesta.txt';
        $table = 'm_option_selling_code_giesta';
