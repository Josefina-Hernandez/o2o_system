...
class importdata_m_fence_base_recommend_wall extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $txt_file = storage_path() . '/import_data/m_fence_base_recommend_wall.txt';
        $table = 'm_fence_base_recommend_wall';	
