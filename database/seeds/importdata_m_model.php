...
class importdata_m_model extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $txt_file = storage_path() . '/import_data/m_model.txt';
        $table = 'm_model';
        //$column_db = ['m_model_id', 'viewer_flg', 'public_flg','img_path','img_name','ctg_model_id','del_flg','sort_order'];
