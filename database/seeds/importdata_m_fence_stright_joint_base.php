...
class importdata_m_fence_stright_joint_base extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $txt_file = storage_path() . '/import_data/m_fence_stright_joint_base.txt';
        $table = 'm_fence_stright_joint_base';	
