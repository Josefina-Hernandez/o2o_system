...
class importdata_product_trans extends Seeder
{
    /**
    ...
    public function run()
    {
       ...
       $import = new ImportDataDb();
        ...
        $table = 'product_trans';
        //$column_db = ['product_id', 'm_lang_id', 'product_name', 'product_desc', 'del_flg'];	
        ...
        $txt_file_lang_en = storage_path() . '/import_data/product_trans.txt';
        $this->_ImportDataToDB($import,$txt_file_lang_en,$table);// lang EN
        
        $txt_file_lang_th = storage_path() . '/import_data/product_trans_THAI.txt';
