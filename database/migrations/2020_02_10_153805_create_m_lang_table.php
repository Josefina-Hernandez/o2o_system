...
class CreateMLangTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create(config('const_db_tostem.db.m_lang.nametable'), function (Blueprint $table) {
            $table->increments(config('const_db_tostem.db.m_lang.column.M_LANG_ID'));
            $table->string(config('const_db_tostem.db.m_lang.column.LANG_CODE'));
            $table->integer(config('const_db_tostem.db.m_lang.column.IS_DEFAULT'));
            $table->integer(config('const_db_tostem.db.m_lang.column.SORT_ORDER'));
    ...
    {
        Schema::dropIfExists(config('const_db_tostem.db.m_lang.nametable'));
    }
}
