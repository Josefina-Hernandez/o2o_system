...
class CreateMModelItemTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create(config('const_db_tostem.db.m_model_item.nametable'), function (Blueprint $table) {
            $table->increments(config('const_db_tostem.db.m_model_item.column.M_MODEL_ITEM_ID'));
    ...
    {
        Schema::dropIfExists(config('const_db_tostem.db.m_model_item.nametable'));
    }
}
