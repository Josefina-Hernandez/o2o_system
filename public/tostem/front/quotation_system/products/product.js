...
var cImageDescription = Vue.component('image-description', Object(function webpackMissingModule() { var e = new Error("Cannot find module './components/cImageDescrition.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
app = new Vue({
  el: '#page',
  components: {
