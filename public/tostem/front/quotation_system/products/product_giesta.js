...
"use strict";
/*!***********************************************************************************!*\
  !*** ./resources/assets/tostem/front/quotation_system/products/product_giesta.js ***!
  \***********************************************************************************/
__webpack_require__.r(__webpack_exports__);
...
app = new Vue({
  ...
  data: function data() {
    return {
      ...
      spec51_img: {},
      options: {},
      //use to foreach option of spec //có thể sẽ xóa đi
      handler_type: {},
      list_spec: [],
  ...
  computed: {
    ...
    checkDisabledSidePanel: function checkDisabledSidePanel() {
      var numSpecDisabled = _.keys(this.specs.disable).length;
    ...
    checkDisabledSpec: function checkDisabledSpec() {
      var result = false;
    ...
    checkDisabledColorHandle: function checkDisabledColorHandle() {
      var result = true,
  ...
  methods: {
    ...
    validateShow: function validateShow() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2() {
        var celling_code_option_amount, check, data_handle_option, side_panel_query;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                celling_code_option_amount = 0, check = function check() {
                  if (_.keys(_this4.specs.select).length > 0 && _.keys(_this4.spec_selected).length != _.keys(_this4.specs.select).length) {
                    return false;
                  }
                  ...
                  if (_.keys(_this4.colors_handle.data).length > 0 && _this4.colors_handle.id == null) {
                    return false;
                  }
                ...
                _context2.next = 5;
                return _this4.queryCellingCodeOption().then(function (response) {
                  _this4.data_query.celling_code_option = response.data;

                  if (_this4.data_query.celling_code_option.length > 0) {
                    _.each(_this4.data_query.celling_code_option, function (row) {
                      celling_code_option_amount += parseFloat(row.amount);
                    });
                  }

                  _this4.total_price = 0;
                  _this4.data_options_result = _.filter(_this4.data_options, _this4.buildQuery(['spec57']));

                  if (_this4.data_options_result.length) {
                    _this4.data_options_result = _this4.data_options_result.slice(0, 1);
                  }

                  _.each(_this4.data_options_result, function (row) {
                    if (row.amount != null) {
              ...
              case 5:
                _context2.next = 7;
                return _this4.selectHiddenData();

              case 7:
                data_handle_option = _.filter(_this4.data_query.option_handle_giesta, {
                  m_color_id: _this4.colors_handle.id,
                  option4: _this4.handle_active
                });

                _.each(data_handle_option, function (row) {
                  if (row.amount != null) {
                    _this4.total_price += parseFloat(row.amount);
                  }
                });

                if (_this4.data_query.side_panel.length > 0) {
                  side_panel_query = {
                    width: _this4.size.width,
                    height: _this4.size.height
                  };

                  _.forEach(_this4.spec_selected, function (value, key) {
                    if (key != 'spec52') {
                      side_panel_query[key] = value;
                    }
                  });

                  _.forEach(_.filter(_this4.data_query.side_panel, side_panel_query), function (row) {
                    _this4.total_price += parseFloat(row.amount);
                  });
                }
    ...
    initModel: function initModel() {
      ...
      this.featured_img_spec51 = null; //reset size
    ...
    buildQuery: function buildQuery() {
      ...
      var all_value_selected = {},
          keySelected = (_ref = _).without.apply(_ref, [['spec', 'option', 'color', 'width', 'height']].concat(_toConsumableArray(this.spec_exclude)));
    ...
    sortHandleType: function sortHandleType(objHandleType) {
      var arrHandlerType = [];

      _.forEach(objHandleType, function (value, key) {
        arrHandlerType.push(value);
      });

      arrHandlerType.sort(function (a, b) {
    ...
    getProduct: function getProduct() {
      ...
      axios.get(_base_app + '/' + lang + '/quotation_system/' + slug_name + '/product/list').then(function (response) {
        ...
        if (response.data.length == 1) {
          ...
          _this7.selectProduct(product.product_id, product.product_name);
        }
    ...
    getSubMenu: function getSubMenu() {
      ...
      axios.get(_base_app + '/' + lang + '/quotation_system/' + slug_name + '/product/get_submenu').then(function (response) {
        _this8.sub_menus = response.data;
      })["catch"](function (error) {
        if (error.response.status == 401) {
    ...
    getDataSellingSpec: function getDataSellingSpec() {
      ...
      axios.get(_base_app + '/' + lang + '/quotation_system/' + slug_name + '/product/get_selling_spec').then(function (response) {
        _this9.data_query.data_m_selling_spec = response.data;

        _this9.filterDataSellingSpec();
      })["catch"](function (error) {
        if (error.response.status == 401) {
    ...
    getCartContentCount: function getCartContentCount() {
      ...
      axios.get(_base_app + '/' + lang + '/cart/get_quantity_cart').then(function (response) {
        _this10.cart_content_count = response.data;
        $('#cart-number').text(_this10.cart_content_count);
      })["catch"](function (error) {
        if (error.response.status == 401) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return _this13.querySpecTrans(_this13.list_spec).then(function (response) {
                  _this13.list_spec_trans = response.data.list_spec_trans;
                  _this13.list_spec_order = response.data.list_spec;
                  _this13.spec_exclude = response.data.spec_exclude;

                  if (typeof response.data.group_label != 'undefined') {
                    _this13.group_label = response.data.group_label;
                  }
                })["catch"](function (error) {
                  if (error.response.status == 401) {
    ...
    getModels: function getModels(product_id) {
      ...
      axios.post(_base_app + '/' + lang + '/quotation_system/' + slug_name + '/product/get_models', {
        ...
        if (response.data.length > 0) {
          _this14.models = response.data;

          _this14.reInitSlider();
        } else {
          _this14.$modal.show('dialog', {
    ...
    getOptions: function getOptions() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee4() {
        var data, firstOption;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return _this15.queryOptions();
              ...
              case 2:
                ...
                _this15.data_options = data.option;
                firstOption = _this15.data_options[0];

                if (data.hasOwnProperty("option_color")) {
                  _this15.colors = data["option_color"];
                }

                if (_this15.colors.hasOwnProperty(firstOption.m_color_id)) {
                  _this15.colors[firstOption.m_color_id]["data_options"] = data.option;
                }

                _this15.data_query.option_handle_giesta = data.option_handle_giesta;
                _this15.mItemDisplay = data.m_item_display;
                _this15.spec_image = data.spec_image;
                _this15.max_decimal = data.max_decimal; //Add BP_O2OQ-7 hainp 20200714

                _context4.next = 14;
                return _this15.fetchAllData();

              case 14:
                _this15.scrollToAddToCart();

                _context4.next = 18;
                break;

              case 17:
                _this15.alert(lang_text.option_not_found);
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                description = {}, lstUndefined = [], groupLabel = _this16.group_label, lstTrans = _this16.list_spec_trans, key = '';
                /** Spec */

                _.each(_this16.spec_selected, function (value, spec) {
                ...
                _.each(_this16.option_selected, function (value, option) {
    ...
    getHandleType: function getHandleType() {
      var _this17 = this;
      ...
      axios.post(_base_app + '/' + lang + '/quotation_system/' + slug_name + '/product/get_giesta_handle_type', {
        ...
        _this17.data_query.option_handle_giesta = response.data;

        if (response.data.length > 0) {
          _.forEach(response.data, function (rowValue, rowIndex) {
            //Color
        ...
        _this17.handler_type = _this17.sortHandleType(objHandleType);
        _this17.colors_handle.data = objColors;

        _loading.css('display', 'none');
      })["catch"](function (error) {
        if (error.response.status == 401) {
          _this17.tokenMismatch();
        }
      });
    },
    getSidePanel: function getSidePanel(specCode, specValue) {
      var _this18 = this;
      ...
      axios.post(_base_app + '/' + lang + '/quotation_system/' + slug_name + '/product/get_giesta_side_panel', {
        ...
        _this18.data_query.side_panel = response.data;
        ...
        if (response.data.length > 0) {
          ...
          if (argSpecTrans.length > 0) {
            _this18.querySpecTrans(argSpecTrans).then(function (result) {
              _.forEach(result.data.list_spec_trans, function (value, key) {
                _this18.$set(_this18.list_spec_trans, key, value);
              });

              _this18.$set(_this18.group_label, '57', lang_text.side_panel); //NOTE: Tạm thời hardcode spec57 = Side Panel (Chưa thay đổi theo ngôn ngữ)
          ...
          if (obj.data.length == 1) {
            _this18.selectSpec57(obj.data[0]);
          } else {
            _this18.$set(_this18.specs.select, 'spec57', obj);
          }
        } else {
          _this18.$delete(_this18.specs.select, 'spec57');
        }

        _loading.css('display', 'none');
      })["catch"](function (error) {
        if (error.response.status == 401) {
          _this18.tokenMismatch();
        }
      }); // }
    },
    ...
    queryCellingCodeOption: function queryCellingCodeOption() {
    ...
    queryOptions: function queryOptions() {
      ...
      return axios.post(_base_app + '/' + lang + '/quotation_system/' + slug_name + '/product/get_options', {
        product_id: this.product_id,
        color_id: (_this$color_id = this.color_id) !== null && _this$color_id !== void 0 ? _this$color_id : 0,
        default_color_id: (_this$m_color_id_defa = this.m_color_id_default) !== null && _this$m_color_id_defa !== void 0 ? _this$m_color_id_defa : 0,
        m_model_id: this.model_id
      }).then(function (response) {
        _loading.css('display', 'none');
    ...
    querySpecTrans: function querySpecTrans(list_spec) {
    ...
    filterDataSellingSpec: function filterDataSellingSpec() {
      ...
      _.forEach(this.data_query.data_m_selling_spec, function (value) {
        if ($.isNumeric(value.m_spec_group_id) === true) {
          if (!_this20.spec_group.includes('spec' + value.m_spec_group_id)) {
            _this20.spec_group.push('spec' + value.m_spec_group_id);
          }
        } else {
          if (!_this20.spec_option.includes('option' + value.m_spec_group_id)) {
            _this20.spec_option.push('option' + value.m_spec_group_id.substr(1));
          }
        }
      });
    },
    fetchAllData: function fetchAllData() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee6() {
        var objFind, objTmp, objHandleType, argKeyMItemDisplay, argKeyObjTmpSpecs, firstKey, firstObj, copyObjTmpSpecs;
            ...
            switch (_context6.prev = _context6.next) {
              case 0:
                objFind = {}, objTmp = {
                  ...
                  mItemDisplay: {},
                  spec51: {}
                }, objHandleType = {}, argKeyMItemDisplay = [];

                if (_this21.mItemDisplay.length > 0) {
                  _this21.mItemDisplay = _.map(_this21.mItemDisplay, function (p) {
                    return _.chain(p).pickBy(_.identity).omit('m_model_id').value();
                  });
                }

                argKeyMItemDisplay = _.keys(_this21.mItemDisplay);

                _.forEach(_this21.data_options, function (rowValue, rowIndex) {
                  _.forIn(rowValue, function (value, colName) {
                    ...
                    if (_.startsWith(colName, "spec")) {
                      if (!argKeyMItemDisplay.includes(colName)) {
                        objFind = _.find(_this21.mItemDisplay, colName);
                        ...
                        if (objFind) {
                          ...
                          if (_this21.list_spec.indexOf(value) == -1) {
                            _this21.list_spec.push(value);
                          }
                        }
                      }
                    }
                ...
                _.forEach(_this21.data_query.option_handle_giesta, function (rowValue, rowIndex) {
                  if (rowValue.option4 == null) {
                    return;
                  }
                  ...
                  if (objTmp.colors_handle.hasOwnProperty(rowValue.m_color_id) === false) {
                    if (rowValue.color_name == 'No Color') {
                      _this21.featured_img = rowValue.img_path_result + '/' + rowValue.img_name_result;
                    } else {
                ...
                if (!(_this21.list_spec.length > 0 && _.keys(_this21.list_spec_trans).length == 0)) {
                  _context6.next = 8;
                  break;
                }

                _context6.next = 8;
                return _this21.getSpecTrans();
                ...
                if (_.keys(objTmp.specs).length > 0) {
                  ...
                  if (firstObj.data.length == 1) {
                    ...
                    _.each(copyObjTmpSpecs, function (_value, _specCode) {
                      _this21.$set(_this21.specs.select, _specCode, _value);

                      _.unset(objTmp.specs, _specCode);

                      if (_value.data.length == 1) {
                        _this21.$set(_this21.spec_selected, _specCode, _value.data[0]);
                      } else {
                        return false;
                      }
                    });
                  } else {
                    _this21.$set(_this21.specs.select, firstKey, firstObj);

                    _.unset(objTmp.specs, firstKey);
                  }
                }

                _this21.specs.disable = objTmp.specs;
                _this21.handler_type = _this21.sortHandleType(objHandleType);
                _this21.colors_handle.data = objTmp.colors_handle;
                _this21.spec51_img = objTmp.spec51;
                _this21.size.data_width = objTmp.widths;
                _this21.size.data_height = objTmp.heights;
                _this21.itemDisplay = objTmp.mItemDisplay;
                _this21.mItemDisplay = _.chain(_this21.mItemDisplay).groupBy('item_display_name').keys().value();

                _this21.validateShow();
    ...
    fetchDataSelected: function fetchDataSelected() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee7() {
        var data, dataHandle, argKeySpecSelected, argKeyMItemDisplay, objHandleType, objTmp, data_filter_option_handle, argKeyObjTmpSpecs, firstKey, firstObj, copyObjTmpSpecs;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                // console.time('fetchDataSelected')
                data = _.filter(_this22.data_options, _this22.buildQuery()), dataHandle = [], argKeySpecSelected = _.keys(_this22.spec_selected), argKeyMItemDisplay = _.keys(_this22.itemDisplay), objHandleType = [], objTmp = {
                  specs: {},
                  width: [],
                  height: [],
                  colors_handle: {}
                ...
                _.forEach(data, function (rowValue, rowIndex) {
                  _.forIn(rowValue, function (value, colName) {
                    if (value == null || _this22.spec_exclude.includes(colName)) {
                      return;
                    }
                    ...
                    if (_.startsWith(colName, "spec")) {
                      ...
                      if (_this22.list_spec.indexOf(value) == -1) {
                        _this22.list_spec.push(value);
                      }
                    }
                  }); //SIZE
                ...
                data_filter_option_handle = [];

                _.forEach(_this22.data_query.option_handle_giesta, function (value, key) {
                  var push_flg = true;

                  _.forEach(_this22.spec_selected, function (specCode, specValue) {
                  ...
                  if (push_flg == true) {
                    if (_this22.handle_active == null) {
                      data_filter_option_handle.push(value);
                    } else if (_this22.handle_active == value.option4) {
                      data_filter_option_handle.push(value);
                    }
                  }
                });
                ...
                _.forEach(data_filter_option_handle, function (rowValue, rowIndex) {
                  ...
                  if (objTmp.colors_handle.hasOwnProperty(rowValue.m_color_id) === false) {
                    if (rowValue.color_name == 'No Color') {
                      _this22.featured_img = rowValue.img_path_result + '/' + rowValue.img_name_result;
                    } else {
                      objTmp.colors_handle[rowValue.m_color_id] = {
                        'm_color_id': rowValue.m_color_id,
                        'color_name': rowValue.color_name,
                ...
                _.each(_this22.spec_exclude, function (value) {
                  _.unset(objTmp.specs, value);
                }); //Chọn sẵn spec nếu chỉ có 1 value


                if (_.keys(objTmp.specs).length > 0) {
                  objTmp.specs = _this22.sortSpec(objTmp.specs);
                  argKeyObjTmpSpecs = _.keys(objTmp.specs), firstKey = argKeyObjTmpSpecs[0], firstObj = objTmp.specs[firstKey];
                  ...
                  if (firstObj.data.length == 1) {
                    ...
                    _.each(copyObjTmpSpecs, function (_value, _specCode) {
                      _this22.$set(_this22.specs.select, _specCode, _value);

                      _.unset(objTmp.specs, _specCode);

                      if (_value.data.length == 1) {
                        _this22.$set(_this22.spec_selected, _specCode, _value.data[0]);
                      } else {
                        return false;
                      }
                    });
                  } else {
                    _this22.$set(_this22.specs.select, firstKey, firstObj);
                ...
                if (objTmp.width.length > 0) {
                  objTmp.width.sort(function (a, b) {
                    return a - b;
                  });
                }

                if (objTmp.height.length > 0) {
                  objTmp.height.sort(function (a, b) {
                    return a - b;
                  });
                }

                _this22.size.data_width = objTmp.width;
                _this22.size.data_height = objTmp.height;
                _this22.size.width = null;
                _this22.size.height = null;
                _this22.specs.disable = objTmp.specs;

                if (_.keys(_this22.spec_selected).includes('spec55') == false) {
                  _this22.handler_type = _this22.sortHandleType(objHandleType);
                }

                _this22.colors_handle.data = objTmp.colors_handle;
                _this22.colors_handle.id = null;
    ...
    fetchDataSelectedColor: function fetchDataSelectedColor() {
      var _this23 = this;

      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee8() {
        var objHandleType, objTmp, selectedColor, argKeyMItemDisplay, argKeyObjTmpSpecs, firstKey, firstObj, copyObjTmpSpecs;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                objHandleType = {}, objTmp = {
                  specs: {},
                  widths: [],
                  heights: [],
                  mItemDisplay: {},
                  colors_handle: {},
                  spec51: {}
                }, selectedColor = _this23.colors[_this23.color_id], argKeyMItemDisplay = _.keys(_this23.itemDisplay);
                ...
                _this23.data_options = _this23.colors[_this23.color_id]["data_options"];
                _context8.next = 7;
                break;

              case 5:
                _context8.next = 7;
                return _this23.getOptions(_this23.color_id);

              case 7:
                _.forEach(_.filter(_this23.data_options, {
                  m_color_id: _this23.color_id
                }), function (rowValue, rowIndex) {
                  _.forIn(rowValue, function (value, colName) {
                    if (value == null) {
                      return;
                    }
                ...
                _.forEach(_this23.data_query.option_handle_giesta, function (rowValue, rowIndex) {
                  if (rowValue.option4 == null) {
                    return;
                  }
                  ...
                  if (objTmp.colors_handle.hasOwnProperty(rowValue.m_color_id) === false) {
                    if (rowValue.color_name == 'No Color') {
                      _this23.featured_img = rowValue.img_path_result + '/' + rowValue.img_name_result;
                    } else {
                      objTmp.colors_handle[rowValue.m_color_id] = {
                        'm_color_id': rowValue.m_color_id,
                        'color_name': rowValue.color_name,
                ...
                _.each(_this23.spec_exclude, function (value) {
                  _.unset(objTmp.specs, value);
                }); //Chọn sẵn spec nếu chỉ có 1 value


                if (_.keys(objTmp.specs).length > 0) {
                  objTmp.specs = _this23.sortSpec(objTmp.specs);
                  argKeyObjTmpSpecs = _.keys(objTmp.specs), firstKey = argKeyObjTmpSpecs[0], firstObj = objTmp.specs[firstKey];
                  ...
                  if (firstObj.data.length == 1) {
                    ...
                    _.each(copyObjTmpSpecs, function (_value, _specCode) {
                      _this23.$set(_this23.specs.select, _specCode, _value);

                      _.unset(objTmp.specs, _specCode);

                      if (_value.data.length == 1) {
                        _this23.$set(_this23.spec_selected, _specCode, _value.data[0]);
                      } else {
                        return false;
                      }
                    });
                  } else {
                    _this23.$set(_this23.specs.select, firstKey, firstObj);

                    _.unset(objTmp.specs, firstKey);
                  }
                }

                _this23.specs.disable = objTmp.specs;
                _this23.handler_type = _this23.sortHandleType(objHandleType);
                _this23.colors_handle.data = objTmp.colors_handle;
                _this23.spec51_img = objTmp.spec51;
                _this23.size.data_width = objTmp.widths;
                _this23.size.data_height = objTmp.heights;

                _this23.validateShow();
    ...
    selectModels: function selectModels(m_model_id, m_color_id_default) {
      ...
      this.initModel();
      this.getOptions();
      history.pushState({}, null, location.pathname + "?mid=" + this.model_id);
    },
    selectColor: function selectColor(key) {
      var _this24 = this;

      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee9() {
        var color_obj, color_id, color_name, color_code, img_name_result, img_path_result;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                color_obj = _this24.colors[key], color_id = color_obj.m_color_id, color_name = color_obj.color_name, color_code = color_obj.color_code_price, img_name_result = color_obj.img_name_result, img_path_result = color_obj.img_path_result;
                _this24.color_id = color_id;
                _this24.color_name = color_name;
                _this24.color_code = color_code;
                _this24.featured_img = img_path_result + '/' + img_name_result;
                _this24.featured_img_spec51 = null;
                _this24.spec_selected = {};
                _this24.specs.select = {};
                _context9.next = 10;
                return _this24.fetchDataSelectedColor();

              case 10:
                _this24.validateShow();
    ...
    selectWidthOnChange: function selectWidthOnChange(event) {
      ...
      _.forEach(_.filter(this.data_options, this.buildQuery(['spec57'])), function (rowValue) {
    ...
    selectSpec: function selectSpec(specCode, specValue, option4) {
      var _this25 = this;

      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee10() {
        var argKeySpecSelected, objSpecKey, boolStartRemove;
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                ...
                argKeySpecSelected = _.keys(_this25.spec_selected), objSpecKey = _this25.specs.select, boolStartRemove = false;

                _this25.$set(_this25.spec_selected, specCode, specValue); //Get featured img spec51


                if (specCode == 'spec51') {
                  _this25.featured_img_spec51 = '/tostem/img/data/' + _this25.spec51_img[specValue].path + '/' + _this25.spec51_img[specValue].name;
                }
                ...
                if (argKeySpecSelected.includes(specCode)) {
                  ...
                  _.forIn(objSpecKey, function (_specValue, _specCode) {
                    if (boolStartRemove == true) {
                      _this25.$delete(_this25.specs.select, _specCode);

                      _this25.$delete(_this25.spec_selected, _specCode);
                ...
                _this25.size.width = null;
                _this25.size.height = null;

                if (specCode == 'spec55') {
                  _this25.handle_active = option4; //filter lại color handle
                }

                _this25.fetchDataSelected(); //Xoá spec57 đi


                _this25.$delete(_this25.specs.select, 'spec57');
    ...
    selectSpecOnchange: function selectSpecOnchange(event) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee11() {
        var specValue, specCode, argKeySpecSelected, boolStartRemove;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                specValue = event.target.value, specCode = event.target.getAttribute('data-spec-code'), argKeySpecSelected = _.keys(_this26.spec_selected), boolStartRemove = false;

                if (specValue != '') {
                  _this26.$set(_this26.spec_selected, specCode, specValue); //Get featured img spec51


                  if (specCode == 'spec51') {
                    _this26.featured_img_spec51 = '/tostem/img/data/' + _this26.spec51_img[specValue].path + '/' + _this26.spec51_img[specValue].name;
                  }
                } else {
                  _this26.$delete(_this26.spec_selected, specCode);

                  if (specCode == 'spec51') {
                    _this26.featured_img_spec51 = null;
                  }
                }
                ...
                if (argKeySpecSelected.includes(specCode)) {
                  //đã chứa spec_code đó rồi
                  //xóa các specCode tiếp theo khi chọn lại
                  _.forIn(_this26.specs.select, function (_specValue, _specCode) {
                    if (boolStartRemove == true) {
                      _this26.$delete(_this26.specs.select, _specCode);

                      _this26.$delete(_this26.spec_selected, _specCode);

                      if (_specCode == 'spec51') {
                        _this26.featured_img_spec51 = null;
                      } else if (_specCode == 'spec55') {
                        _this26.handle_active = null;
                      }
                    }
                ...
                _this26.size.width = null;
                _this26.size.height = null;

                if (specCode == 'spec55') {
                  if (event.target.options.selectedIndex > -1) {
                    _this26.handle_active = event.target.options[event.target.options.selectedIndex].getAttribute('option4');
                  }
                }

                _this26.fetchDataSelected(); //Xoá spec57 đi


                _this26.$delete(_this26.specs.select, 'spec57');
     ...
     * Select Side panel
     */
    selectSpec57: function selectSpec57(specValue) {
      this.$set(this.spec_selected, 'spec57', specValue);
      this.validateShow();
    },
    selectSpec57Onchange: function selectSpec57Onchange() {
    ...
    selectHiddenData: function selectHiddenData() {
      var _this27 = this;
      ...
      axios.post(_base_app + '/' + lang + '/quotation_system/' + slug_name + '/product/get_giesta_hidden_data', {
        ...
        var amount = 0;
        _this27.data_query.hidden_option = response.data;

        _.each(response.data, function (data, type) {
        ...
        _this27.total_price += amount;
      })["catch"](function (error) {
        if (error.response.status == 401) {
          _this27.tokenMismatch();
        }
      });
    },
    selectColorHandle: function selectColorHandle(m_color_id, color_name) {
    ...
    add__cart: function add__cart() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee12() {
        var cart_uri, lang, description, side_panel_query;
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                ...
                lang = _this28.lang;
                _context12.next = 4;
                return _this28.getDescriptionCart();

              case 4:
                description = _context12.sent;

                if (_this28.colors_handle.id != null) {
                  _this28.$set(_this28.data_query.hidden_option, 'option_handle', _.filter(_this28.data_query.option_handle_giesta, {
                    m_color_id: _this28.colors_handle.id,
                    option4: _this28.handle_active
                  }));
                } else {
                  _this28.$set(_this28.data_query.hidden_option, 'option_handle', _this28.data_query.option_handle_giesta);
                }

                if (_this28.data_query.side_panel.length > 0) {
                  side_panel_query = {
                    width: _this28.size.width,
                    height: _this28.size.height
                  };

                  _.forEach(_this28.spec_selected, function (value, key) {
                    if (key != 'spec52') {
                      side_panel_query[key] = value;
                    }
                  });

                  _this28.$set(_this28.data_query.hidden_option, 'side_panel', _.filter(_this28.data_query.side_panel, side_panel_query));
                } else {
                  _this28.$set(_this28.data_query.hidden_option, 'side_panel', []);
                }

                axios.post(_base_app + '/' + lang + '/cart/add-to-cart', _defineProperty({
                  ctg_id: _this28.ctg_id,
                  product_id: _this28.product_id,
                  spec1: _this28.spec1,
                  model_id: _this28.model_id,
                  option_selected: _this28.option_selected,
                  spec_selected: _this28.spec_selected,
                  height_selected: _this28.formatNumber(_this28.size.height),
                  width_selected: _this28.formatNumber(_this28.size.width),
                  color_id: _this28.color_id,
                  featured_img: _this28.featured_img,
                  display_pitch_list: _this28.display_pitch_list
                }, lang, {
                  product_name: _this28.product_name,
                  spec1_name: _this28.spec1_name,
                  model: _.find(_this28.models, ['m_model_id', _this28.model_id]),
                  color_name: _this28.color_name,
                  color_code: _this28.color_code,
                  spec_selected: _this28.spec_selected,
                  option_selected: _this28.option_selected,
                  data_options_selected: _this28.data_options_result,
                  celling_code_option: _this28.data_query.celling_code_option,
                  hidden_option: _this28.data_query.hidden_option,
                  description: description
                })).then(function (response) {
                  _this28.getCartContentCount();

                  _this28.alert(lang_text.added_to_cart);
                })["catch"](function (error) {
                  console.log(error.response);

                  if (error.response.status == 401) {
                    _this28.tokenMismatch();
                  }
                });
    ...
    getSpecImage: function getSpecImage(spec, label) {
...
/******/ })()
;
//# sourceMappingURL=product_giesta.js.map